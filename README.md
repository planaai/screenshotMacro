...
- 해당 프로그램은 윈도우의 배율을 125%로 고정해주시고 블루아카이브 PC 클라이언트의 전체화면 모드에서 실행하셔야 원활한 작동을 합니다. 또한 지원되는 해상도는 21:9 와 16:9 해상도이며 그 외의 해상도는 지원하지 않습니다.

- 본 프로그램은 python 버전 3.13 이상에서 구동하는것을 권장드리며 Microsoft Store에서 다운로드한 파이선이 아닌 python.org을 통해 다운로드한 파이선으로 구동을 하셔야 작동이 됩니다.
